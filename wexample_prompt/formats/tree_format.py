...
class TreeFormat(BaseFormat):
    """Format for displaying hierarchical data in a tree structure."""
    
    @classmethod
    def create(cls, data: Dict[str, Any]) -> 'TreeFormat':
        """Create a tree format response."""
        lines = []
