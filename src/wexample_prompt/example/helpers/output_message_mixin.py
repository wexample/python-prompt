...
class OutputMessageMixin:
    ...
    def _output_message(
        ...
        kwargs = self._build_kwargs_for_response(response_class, message, **extra_kwargs)
    ...
    def _build_kwargs_for_response(
        ...
        elif issubclass(response_class, (TitlePromptResponse, SubtitlePromptResponse, SeparatorPromptResponse)):
            kwargs["text"] = message
        else:
