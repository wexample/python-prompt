...
class TestIoManager(AbstractPromptTest):
    ...
    def test_instantiate_extended_base_model(self) -> None:
        from wexample_prompt.testing.resources.classes.extended_base_model_with_io_manager import ExtendedBaseModelWithIoManager
    ...
    def test_instantiate_extended_base_model_required(self) -> None:
        from wexample_prompt.testing.resources.classes.extended_base_model_with_required_io_manager import ExtendedBaseModelWithRequiredIoManager
